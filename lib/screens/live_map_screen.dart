            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isActive ? const Color(0xFF1A73E8).withOpacity(0.2) : Colors.white.withOpacity(0.04),
                  borderRadius: BorderRadius.circular(14),
                  border: Border.all(color: isActive ? const Color(0xFF1A73E8) : Colors.white.withOpacity(0.08),
                    width: isActive ? 2 : 1),
                ),
                child: Column(children: [
                  Text(style['icon'] ?? '', style: const TextStyle(fontSize: 24)),
    ...
    return Column(
      ...
      children: [
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
          decoration: BoxDecoration(
            color: speed > 1 ? const Color(0xFF00BFA5) : const Color(0xFF424242),
            borderRadius: BorderRadius.circular(8),
          ),
          child: Text(
            LocationService.formatSpeed(speed),
        ...
        Container(
          ...
          child: CircleAvatar(
            ...
            backgroundColor: const Color(0xFF161B22),
            child: photo.isEmpty
                ? Text(name.isNotEmpty ? name[0] : '?', style: const TextStyle(color: Colors.white, fontSize: 14))
                : null,
          ),
        ),
        Container(
